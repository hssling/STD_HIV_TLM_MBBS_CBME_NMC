...
def create_hiv_presentation():
    ...
    p = tf.add_paragraph()
    p.text = 'Acute HIV Infection (2-4 weeks):'
    p.level = 1

    p = tf.add_paragraph()
    p.text = '• High viral replication'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Seroconversion illness (flu-like symptoms)'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Peak viremia (millions of copies/mL)'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Temporary CD4 decline'
    p.level = 2

    p = tf.add_paragraph()
    p.text = 'Clinical Latency (8-10 years):'
    p.level = 1

    p = tf.add_paragraph()
    p.text = '• Low-level viral replication'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• CD4 count gradually declines'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Asymptomatic period'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Viral set point established'
    p.level = 2
    ...
    p = tf.add_paragraph()
    p.text = '• CD4 <500 cells/μL'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Persistent generalized lymphadenopathy'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Weight loss, fatigue'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Opportunistic infections'
    p.level = 2

    p = tf.add_paragraph()
    p.text = 'AIDS (CD4 <200 cells/μL):'
    p.level = 1

    p = tf.add_paragraph()
    p.text = '• Severe immunosuppression'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Life-threatening opportunistic infections'
    p.level = 2
    ...
    p = tf.add_paragraph()
    p.text = '• Highest prevalence: Northeast states'
    p.level = 2
    ...
    p = tf.add_paragraph()
    p.text = '• Urban vs Rural: Higher in urban areas (0.29% vs 0.19%)'
    p.level = 2
    ...
    p = tf.add_paragraph()
    p.text = '• Measures immune status'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Normal: 500-1500 cells/μL'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• ART initiation: Any CD4 count'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• OI prophylaxis: CD4 <200'
    p.level = 2
    ...
    p = tf.add_paragraph()
    p.text = '• Measures viral replication'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Target: Undetectable (<50 copies/mL)'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Monitoring: Every 6 months on ART'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Virologic failure: >1000 copies/mL'
    p.level = 2
    ...
    p = tf.add_paragraph()
    p.text = '• Complete blood count'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Liver/renal function tests'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Lipid profile, glucose'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Drug resistance testing (when indicated)'
    p.level = 2
    ...
    p = tf.add_paragraph()
    p.text = '• TLD: Tenofovir 300mg + Lamivudine 300mg + Dolutegravir 50mg (single pill)'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• TLE: Tenofovir 300mg + Lamivudine 300mg + Efavirenz 600mg (single pill)'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• AZT-based: Zidovudine + Lamivudine + Efavirenz'
    p.level = 2
    ...
    p = tf.add_paragraph()
    p.text = '• Lifelong treatment'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• High adherence (>95%) essential'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Fixed-dose combinations simplify therapy'
    p.level = 2

    p = tf.add_paragraph()
    p.text = '• Regular monitoring required'
    p.level = 2
    ...
    prs.save('HIV_One_Hour_Class.pptx')
    print("HIV presentation created successfully!")

if __name__ == "__main__":
    create_hiv_presentation()
